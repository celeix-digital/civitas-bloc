 const organizationUrl = 'http://localhost:8080/v1/front/organizations/create'
...
const createOrganizationButton = (document.getElementById('createOrganizationButton').onclick = async function () {
  ...
  // const organizationCodeInput = document.getElementById('organizationCodeInput')
  ...
  // const organizationCodeValue = organizationCodeInput.value
  ...
  let data = {
    ...
    webiste: websiteAboutOrganizationValue,
    serviceProvided: serviceProvidedValue,
    walletAddress: walletAddressValue,
    logo:logoInput,
    // organizationCode: organizationCodeValue,
  ...
  let response = await postData(data)
   console.log('response organizationId', response)
   data.typeValue = response
   console.log("updated data",data)
    let postResponse = await postOrganizationData(data)
   ...
   if (postResponse && postResponse.status) {
    ...
    // if (organizationCodeValue.value) organizationCodeValue.value = ''
