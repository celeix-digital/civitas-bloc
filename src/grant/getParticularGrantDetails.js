let url = 'http://localhost:8080/v1/front/grants/get'
...
const getParticularGrantButton = (document.getElementById(
    'getParticularGrantButton'
).onclick = async function () {
    let id = "6371d0a63b839e54040199eb";
    console.log("id", id);
    let response = await getParticularGrant(id)
    if (response.grantDetail) {
